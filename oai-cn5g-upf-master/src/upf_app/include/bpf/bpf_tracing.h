...
#define BPF_KRETPROBE_READ_RET_IP(ip, ctx)                                     \
  ({                                                                           \
    bpf_probe_read_kernel(                                                     \
        &(ip), sizeof(ip), (void*) (PT_REGS_FP(ctx) + sizeof(ip)));            \
  })
...
#define PT_REGS_PARM1_CORE_SYSCALL(x)                                          \
  BPF_CORE_READ(__PT_REGS_CAST(x), __PT_PARM1_SYSCALL_REG)
#endif
...
#define PT_REGS_PARM2_CORE_SYSCALL(x)                                          \
  BPF_CORE_READ(__PT_REGS_CAST(x), __PT_PARM2_SYSCALL_REG)
#endif
...
#define PT_REGS_PARM5_CORE_SYSCALL(x)                                          \
  BPF_CORE_READ(__PT_REGS_CAST(x), __PT_PARM5_SYSCALL_REG)
#endif
#ifndef PT_REGS_PARM6_SYSCALL
#define PT_REGS_PARM6_SYSCALL(x) (__PT_REGS_CAST(x)->__PT_PARM6_SYSCALL_REG)
#define PT_REGS_PARM6_CORE_SYSCALL(x)                                          \
  BPF_CORE_READ(__PT_REGS_CAST(x), __PT_PARM6_SYSCALL_REG)
#endif
#ifndef PT_REGS_PARM7_SYSCALL
#define PT_REGS_PARM7_SYSCALL(x) (__PT_REGS_CAST(x)->__PT_PARM7_SYSCALL_REG)
#define PT_REGS_PARM7_CORE_SYSCALL(x)                                          \
  BPF_CORE_READ(__PT_REGS_CAST(x), __PT_PARM7_SYSCALL_REG)
#endif
...
#define PT_REGS_PARM6_SYSCALL(x)                                               \
  ({                                                                           \
    _Pragma(__BPF_TARGET_MISSING);                                             \
    0l;                                                                        \
  })
#define PT_REGS_PARM7_SYSCALL(x)                                               \
  ({                                                                           \
    _Pragma(__BPF_TARGET_MISSING);                                             \
    0l;                                                                        \
  })
...
#define BPF_PROG(name, args...)                                                                  \
  ...
  static __always_inline typeof(name(0)) ____##name(                                             \
      unsigned long long* ctx, ##args);                                                          \
  typeof(name(0)) name(unsigned long long* ctx) {                                                \
    _Pragma("GCC diagnostic push") _Pragma(                                                      \
        "GCC diagnostic ignored \"-Wint-conversion\"") return ____##name(___bpf_ctx_cast(args)); \
...
#ifndef ___bpf_nth2
#define ___bpf_nth2(                                                           \
    _, _1, _2, _3, _4, _5, _6, _7, _8, _9, _10, _11, _12, _13, _14, _15, _16,  \
    _17, _18, _19, _20, _21, _22, _23, _24, N, ...)                            \
  N
#endif
#ifndef ___bpf_narg2
#define ___bpf_narg2(...)                                                      \
  ___bpf_nth2(                                                                 \
      _, ##__VA_ARGS__, 12, 12, 11, 11, 10, 10, 9, 9, 8, 8, 7, 7, 6, 6, 5, 5,  \
      4, 4, 3, 3, 2, 2, 1, 1, 0)
#endif
  ...
  __builtin_choose_expr(                                                       \
      ...
      __builtin_choose_expr(                                                   \
          ...
          __builtin_choose_expr(                                               \
              ...
              __builtin_choose_expr(                                           \
                  sizeof(t) == 8, 1,                                           \
                  __builtin_choose_expr(sizeof(t) == 16, 2, (void) 0)))))

#define ___bpf_reg_cnt0() (0)
#define ___bpf_reg_cnt1(t, x) (___bpf_reg_cnt0() + ___bpf_treg_cnt(t))
#define ___bpf_reg_cnt2(t, x, args...)                                         \
  (___bpf_reg_cnt1(args) + ___bpf_treg_cnt(t))
#define ___bpf_reg_cnt3(t, x, args...)                                         \
  (___bpf_reg_cnt2(args) + ___bpf_treg_cnt(t))
#define ___bpf_reg_cnt4(t, x, args...)                                         \
  (___bpf_reg_cnt3(args) + ___bpf_treg_cnt(t))
#define ___bpf_reg_cnt5(t, x, args...)                                         \
  (___bpf_reg_cnt4(args) + ___bpf_treg_cnt(t))
#define ___bpf_reg_cnt6(t, x, args...)                                         \
  (___bpf_reg_cnt5(args) + ___bpf_treg_cnt(t))
#define ___bpf_reg_cnt7(t, x, args...)                                         \
  (___bpf_reg_cnt6(args) + ___bpf_treg_cnt(t))
#define ___bpf_reg_cnt8(t, x, args...)                                         \
  (___bpf_reg_cnt7(args) + ___bpf_treg_cnt(t))
#define ___bpf_reg_cnt9(t, x, args...)                                         \
  (___bpf_reg_cnt8(args) + ___bpf_treg_cnt(t))
#define ___bpf_reg_cnt10(t, x, args...)                                        \
  (___bpf_reg_cnt9(args) + ___bpf_treg_cnt(t))
#define ___bpf_reg_cnt11(t, x, args...)                                        \
  (___bpf_reg_cnt10(args) + ___bpf_treg_cnt(t))
#define ___bpf_reg_cnt12(t, x, args...)                                        \
  (___bpf_reg_cnt11(args) + ___bpf_treg_cnt(t))
#define ___bpf_reg_cnt(args...)                                                \
  ___bpf_apply(___bpf_reg_cnt, ___bpf_narg2(args))(args)
                  ...
                  __builtin_choose_expr(                                       \
                      sizeof(t) == 16, ({                                      \
                        union {                                                \
                          __u64 z[2];                                          \
                          t x;                                                 \
                        } ___t = {.z = {ctx[n], ctx[n + 1]}};                  \
                        ___t.x;                                                \
                      }),                                                      \
                      (void) 0)))))

#define ___bpf_ctx_arg0(n, args...)
#define ___bpf_ctx_arg1(n, t, x)                                               \
  , ___bpf_union_arg(t, x, n - ___bpf_reg_cnt1(t, x))
#define ___bpf_ctx_arg2(n, t, x, args...)                                      \
  , ___bpf_union_arg(t, x, n - ___bpf_reg_cnt2(t, x, args))                    \
        ___bpf_ctx_arg1(n, args)
#define ___bpf_ctx_arg3(n, t, x, args...)                                      \
  , ___bpf_union_arg(t, x, n - ___bpf_reg_cnt3(t, x, args))                    \
        ___bpf_ctx_arg2(n, args)
#define ___bpf_ctx_arg4(n, t, x, args...)                                      \
  , ___bpf_union_arg(t, x, n - ___bpf_reg_cnt4(t, x, args))                    \
        ___bpf_ctx_arg3(n, args)
#define ___bpf_ctx_arg5(n, t, x, args...)                                      \
  , ___bpf_union_arg(t, x, n - ___bpf_reg_cnt5(t, x, args))                    \
        ___bpf_ctx_arg4(n, args)
#define ___bpf_ctx_arg6(n, t, x, args...)                                      \
  , ___bpf_union_arg(t, x, n - ___bpf_reg_cnt6(t, x, args))                    \
        ___bpf_ctx_arg5(n, args)
#define ___bpf_ctx_arg7(n, t, x, args...)                                      \
  , ___bpf_union_arg(t, x, n - ___bpf_reg_cnt7(t, x, args))                    \
        ___bpf_ctx_arg6(n, args)
#define ___bpf_ctx_arg8(n, t, x, args...)                                      \
  , ___bpf_union_arg(t, x, n - ___bpf_reg_cnt8(t, x, args))                    \
        ___bpf_ctx_arg7(n, args)
#define ___bpf_ctx_arg9(n, t, x, args...)                                      \
  , ___bpf_union_arg(t, x, n - ___bpf_reg_cnt9(t, x, args))                    \
        ___bpf_ctx_arg8(n, args)
#define ___bpf_ctx_arg10(n, t, x, args...)                                     \
  , ___bpf_union_arg(t, x, n - ___bpf_reg_cnt10(t, x, args))                   \
        ___bpf_ctx_arg9(n, args)
#define ___bpf_ctx_arg11(n, t, x, args...)                                     \
  , ___bpf_union_arg(t, x, n - ___bpf_reg_cnt11(t, x, args))                   \
        ___bpf_ctx_arg10(n, args)
#define ___bpf_ctx_arg12(n, t, x, args...)                                     \
  , ___bpf_union_arg(t, x, n - ___bpf_reg_cnt12(t, x, args))                   \
        ___bpf_ctx_arg11(n, args)
#define ___bpf_ctx_arg(args...)                                                \
  ___bpf_apply(___bpf_ctx_arg, ___bpf_narg2(args))(___bpf_reg_cnt(args), args)
...
#define ___bpf_ctx_decl(args...)                                               \
  ___bpf_apply(___bpf_ctx_decl, ___bpf_narg2(args))(args)
...
#define BPF_PROG2(name, args...)                                               \
  name(unsigned long long* ctx);                                               \
  static __always_inline typeof(name(0)) ____##name(                           \
      unsigned long long* ctx ___bpf_ctx_decl(args));                          \
  typeof(name(0)) name(unsigned long long* ctx) {                              \
...
#define ___bpf_kprobe_args1(x)                                                 \
  ___bpf_kprobe_args0(), (unsigned long long) PT_REGS_PARM1(ctx)
#define ___bpf_kprobe_args2(x, args...)                                        \
  ___bpf_kprobe_args1(args), (unsigned long long) PT_REGS_PARM2(ctx)
#define ___bpf_kprobe_args3(x, args...)                                        \
  ___bpf_kprobe_args2(args), (unsigned long long) PT_REGS_PARM3(ctx)
#define ___bpf_kprobe_args4(x, args...)                                        \
  ___bpf_kprobe_args3(args), (unsigned long long) PT_REGS_PARM4(ctx)
#define ___bpf_kprobe_args5(x, args...)                                        \
  ___bpf_kprobe_args4(args), (unsigned long long) PT_REGS_PARM5(ctx)
#define ___bpf_kprobe_args6(x, args...)                                        \
  ___bpf_kprobe_args5(args), (unsigned long long) PT_REGS_PARM6(ctx)
#define ___bpf_kprobe_args7(x, args...)                                        \
  ___bpf_kprobe_args6(args), (unsigned long long) PT_REGS_PARM7(ctx)
#define ___bpf_kprobe_args8(x, args...)                                        \
  ___bpf_kprobe_args7(args), (unsigned long long) PT_REGS_PARM8(ctx)
...
#define BPF_KPROBE(name, args...)                                                                   \
  ...
  typeof(name(0)) name(struct pt_regs* ctx) {                                                       \
    _Pragma("GCC diagnostic push") _Pragma(                                                         \
        "GCC diagnostic ignored \"-Wint-conversion\"") return ____##name(___bpf_kprobe_args(args)); \
    _Pragma("GCC diagnostic pop")                                                                   \
  }                                                                                                 \
...
#define ___bpf_kretprobe_args1(x)                                              \
  ___bpf_kretprobe_args0(), (unsigned long long) PT_REGS_RC(ctx)
...
#define BPF_KRETPROBE(name, args...)                                                                   \
  ...
  typeof(name(0)) name(struct pt_regs* ctx) {                                                          \
    _Pragma("GCC diagnostic push") _Pragma(                                                            \
        "GCC diagnostic ignored \"-Wint-conversion\"") return ____##name(___bpf_kretprobe_args(args)); \
    _Pragma("GCC diagnostic pop")                                                                      \
  }                                                                                                    \
  static __always_inline typeof(name(0)) ____##name(struct pt_regs* ctx, ##args)
...
/* If kernel doesn't have CONFIG_ARCH_HAS_SYSCALL_WRAPPER, we have to
 * BPF_CORE_READ from pt_regs */
...
#define ___bpf_syswrap_args2(x, args...)                                       \
  ___bpf_syswrap_args1(args),                                                  \
      (unsigned long long) PT_REGS_PARM2_CORE_SYSCALL(regs)
#define ___bpf_syswrap_args3(x, args...)                                       \
  ___bpf_syswrap_args2(args),                                                  \
      (unsigned long long) PT_REGS_PARM3_CORE_SYSCALL(regs)
#define ___bpf_syswrap_args4(x, args...)                                       \
  ___bpf_syswrap_args3(args),                                                  \
      (unsigned long long) PT_REGS_PARM4_CORE_SYSCALL(regs)
#define ___bpf_syswrap_args5(x, args...)                                       \
  ___bpf_syswrap_args4(args),                                                  \
      (unsigned long long) PT_REGS_PARM5_CORE_SYSCALL(regs)
#define ___bpf_syswrap_args6(x, args...)                                       \
  ___bpf_syswrap_args5(args),                                                  \
      (unsigned long long) PT_REGS_PARM6_CORE_SYSCALL(regs)
#define ___bpf_syswrap_args7(x, args...)                                       \
  ___bpf_syswrap_args6(args),                                                  \
      (unsigned long long) PT_REGS_PARM7_CORE_SYSCALL(regs)
#define ___bpf_syswrap_args(args...)                                           \
  ___bpf_apply(___bpf_syswrap_args, ___bpf_narg(args))(args)
...
#define BPF_KSYSCALL(name, args...)                                                  \
  ...
  typeof(name(0)) name(struct pt_regs* ctx) {                                        \
    ...
    _Pragma("GCC diagnostic push")                                                   \
        _Pragma("GCC diagnostic ignored \"-Wint-conversion\"") if (                  \
            LINUX_HAS_SYSCALL_WRAPPER) return ____##name(___bpf_syswrap_args(args)); \
    else return ____##name(___bpf_syscall_args(args));                               \
    _Pragma("GCC diagnostic pop")                                                    \
  }                                                                                  \
  static __always_inline typeof(name(0)) ____##name(struct pt_regs* ctx, ##args)
